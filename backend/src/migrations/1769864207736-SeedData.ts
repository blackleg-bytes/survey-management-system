...
export class SeedData1769864207736 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        // 1. Users (password_hash is 'password' for all for now)
        await queryRunner.query(`
            INSERT INTO "users" ("id", "email", "password_hash", "role") VALUES 
            ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'admin@example.com', 'password', 'ADMIN'),
            ('b0eebc99-9c0b-4ef8-bb6d-6bb9bd380a12', 'officer@example.com', 'password', 'OFFICER');
        `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DELETE FROM "users" WHERE "id" IN ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'b0eebc99-9c0b-4ef8-bb6d-6bb9bd380a12')`);
        await queryRunner.query(`DELETE FROM "surveys" WHERE "id" = 'c0eebc99-9c0b-4ef8-bb6d-6bb9bd380a13'`);
